...
(function() {
  ...
  define(['cream'], function(Cream) {
    var TagHelper, helper;
    TagHelper = (function() {
      var BOOLEAN_ATTRIBUTES, HTML_ESCAPE, JSON_ESCAPE;
      ...
      BOOLEAN_ATTRIBUTES = ['disabled', 'readonly', 'multiple', 'checked', 'autobuffer', 'autoplay', 'controls', 'loop', 'selected', 'hidden', 'scoped', 'async', 'defer', 'reversed', 'ismap', 'seemless', 'muted', 'required', 'autofocus', 'novalidate', 'formnovalidate', 'open', 'pubdate'];
      ...
      TagHelper.prototype.tag_options = function(options, escape) {
        ...
        if (keys.length !== 0) {
          ...
          for (key in options) {
            ...
            } else if (__indexOf.call(BOOLEAN_ATTRIBUTES, key) >= 0) {
              if (value) {
                attrs.push("" + key + "=\"" + key + "\"");
              }
