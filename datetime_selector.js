...
(function() {
  ...
  define(['cream', 'tag_helper'], function(Cream, TagHelper) {
    var DateTimeSelector;
    return DateTimeSelector = (function() {
      ...
      DateTimeSelector.prototype.select_datetime = function() {
        var o, order, _base, _base1, _base2, _base3, _base4, _i, _len, _ref;
        ...
        (_base1 = this.options).discard_month || (_base1.discard_month = __indexOf.call(order, 'month') < 0 ? true : void 0);
        (_base2 = this.options).discard_day || (_base2.discard_day = this.options.discard_month || (__indexOf.call(order, 'day') < 0) ? true : void 0);
        (_base3 = this.options).discard_minute || (_base3.discard_minute = this.options.discard_hour ? true : void 0);
        (_base4 = this.options).discard_second || (_base4.discard_second = !(this.options.include_seconds && (!this.options.discard_minute)) ? true : void 0);
      ...
      DateTimeSelector.prototype.select_date = function() {
        var o, order, ret, _base, _base1, _base2, _i, _len, _ref;
        order = Object.clone(this.date_order());
      ...
      DateTimeSelector.prototype.build_options = function(selected, options) {
        var i, leading_zeros, select_options, start, step, stop, tag_options, text, value, _i;
        if (options == null) {
          options = {};
        }
        start = 0;
