...
(function() {
  ...
  define(['strftime'], function(strftime) {
    ...
    Object.invert = function(obj) {
      var k, v;
      return Object.fromArray((function() {
        var _results;
        _results = [];
        for (k in obj) {
          if (!__hasProp.call(obj, k)) continue;
    ...
    Array.prototype.zip = function() {
      var arr, arrs, group, i, max_len, ret, _i, _j, _len;
      ...
      ret = [];
      for (i = _i = 0; 0 <= max_len ? _i < max_len : _i > max_len; i = 0 <= max_len ? ++_i : --_i) {
        group = [];
        for (_j = 0, _len = arrs.length; _j < _len; _j++) {
          arr = arrs[_j];
          group.push(arr[i]);
        }
        ret.push(group);
    ...
    return Date.prototype.strftime = function(str) {
