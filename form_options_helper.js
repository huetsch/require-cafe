  ...
  define(['cream', 'tag_helper'], function(Cream, TagHelper) {
    ...
    FormOptionsHelper = (function() {
      ...
      FormOptionsHelper.prototype.options_for_select = function(container, selected) {
        ...
        return container.map((function(_this) {
          return function(element) {
            var disabled_attribute, html_attributes, selected_attribute, text, value, _ref1;
            html_attributes = _this.option_html_attributes(element);
            _ref1 = _this.option_text_and_value(element).map(function(item) {
              if (item instanceof String) {
                return item;
              } else {
                return String(item);
              }
            }), text = _ref1[0], value = _ref1[1];
      ...
      FormOptionsHelper.prototype.option_text_and_value = function(option) {
        if (option instanceof Array) {
          option = option.reject((function(_this) {
            return function(e) {
              return Object.isPlainObject(e);
            };
          })(this));
